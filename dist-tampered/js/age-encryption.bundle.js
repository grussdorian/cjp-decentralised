...
var base64nopad = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ chain(/* @__PURE__ */ radix2(6), /* @__PURE__ */ alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), /* @__PURE__ */ join("")));
...
var KitchenSink_ml_kem768_x25519 = createKitchenSink("KitchenSink-KEM(ML-KEM-768,X25519)-XOF(SHAKE256)-KDF(HKDF-SHA-256)", ml_kem768, x25519kem, shake256, sha2562);
...
function invert2(number, modulo) {
  ...
  let b = modulo;
  let x = _0n8, y = _1n9, u = _1n9, v = _0n8;
  while (a !== _0n8) {
    const q = b / a;
    const r = b - a * q;
    const m = x - u * q;
...
function calcElligatorRistrettoMap(r0) {
  ...
  const Ns = mod4((r + _1n14) * ONE_MINUS_D_SQ);
  let c = BigInt(-1);
  ...
  if (!Ns_D_is_sq)
    c = r;
  const Nt = mod4(c * (r - _1n14) * D_MINUS_ONE_SQ - D);
  const s2 = s * s;
  const W0 = mod4((s + s) * D);
  const W1 = mod4(Nt * SQRT_AD_MINUS_ONE);
  const W2 = mod4(_1n14 - s2);
  const W3 = mod4(_1n14 + s2);
