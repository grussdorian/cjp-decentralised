...
2. Open any mirror — the badge must show the **same version number** and **same IPFS CID** (`bafybeict6qjgzzp2wvbktlz5i7adk2m7wblsfum27ce3v5qpt2iishuzjm`).
...
```
https://ipfs.io/ipfs/bafybeict6qjgzzp2wvbktlz5i7adk2m7wblsfum27ce3v5qpt2iishuzjm
```
...
| IPFS gateway | [`ipfs.io/ipfs/bafybeict6qjgzzp2wvbktlz5i7adk2m7wblsfum27ce3v5qpt2iishuzjm`](https://ipfs.io/ipfs/bafybeict6qjgzzp2wvbktlz5i7adk2m7wblsfum27ce3v5qpt2iishuzjm) |
| IPNS | pending |
